        ...
        if (!gameEnded) {
            ...
            if (!gameStarted) {
                ...
                if (!level_0_completed) {
                    ...
                    if (frameCounter % PIPES_FRAME_DIFF == 0) {
                        frameCounter = 0;
                    ...
                    for (i = 0; i < pipesLevel_0.size(); i++) {
                        ...
                        if (pipes.getPosition().x < -pipes.getWidth()) {
                            ...
                            System.out.println(birdieLevel_0.getPosition().x + "  " + pipes.getPosition().x + pipes.getWidth() + "\n");
                ...
                //Level up screen
                    ...
                    if (!level_1_completed) {
                        frameCounter += 1;  // for drawing pipes every 100 frames
                        // Lvl 1
                        // Drawing lives
